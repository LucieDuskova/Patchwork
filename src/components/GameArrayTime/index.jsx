...
export const GameArrayTime = ({  state }) => {
  ...
  score[0] = {
    ...
    left: 0 * state.box_weight + state.edge,
    color: '#ff0000',
    text: '0',
  ...
  score[1] = {
    top: 0 * state.box_weight + state.edge,
    left: 1 * state.box_weight + state.edge,
    color: '#ff0000',
    text: '1',
  ...
  score[2] = {
    top: 0 * state.box_weight + state.edge,
    left: 2 * state.box_weight + state.edge,
    color: '#ff0000',
    text: '2',
    borderWidth: '4px 1px 1px 1px',
  };
  score[3] = {
    top: 0 * state.box_weight + state.edge,
    left: 3 * state.box_weight + state.edge,
    color: '#ffc43a',
    text: '3',
    borderWidth: '4px 1px 1px 1px',
  };
  score[4] = {
    top: 0 * state.box_weight + state.edge,
    left: 4 * state.box_weight + state.edge,
    color: '#ffc43a',
    text: '4',
    borderWidth: '4px 1px 1px 1px',
  };
  score[5] = {
    top: 0 * state.box_weight + state.edge,
    left: 5 * state.box_weight + state.edge,
    color: '#ffc43a',
    text: '5',
    borderWidth: '4px 1px 1px 1px',
  };
  score[6] = {
    top: 0 * state.box_weight + state.edge,
    left: 6 * state.box_weight + state.edge,
    color: '#ffc43a',
    text: '6',
    borderWidth: '4px 1px 1px 1px',
  };
  score[7] = {
    top: 0 * state.box_weight + state.edge,
    left: 7 * state.box_weight + state.edge,
    button: true,
    color: '#3498db',
    text: '7',
  ...
  score[8] = {
    top: 1 * state.box_weight + state.edge,
    left: 7 * state.box_weight + state.edge,
    color: '#ffc43a',
    text: '8',
  ...
  score[9] = {
    top: 2 * state.box_weight + state.edge,
    left: 7 * state.box_weight + state.edge,
    color: '#ffc43a',
    text: '9',
    borderWidth: '1px 4px 1px 1px',
  ...
  score[10] = {
    top: 3 * state.box_weight + state.edge,
    left: 7 * state.box_weight + state.edge,
    color: '#ffc43a',
    text: '10',
    borderWidth: '1px 4px 1px 1px',
  ...
  score[11] = {
    top: 4 * state.box_weight + state.edge,
    left: 7 * state.box_weight + state.edge,
    color: '#ffc43a',
    text: '11',
    borderWidth: '1px 4px 1px 1px',
  ...
  score[12] = {
    top: 5 * state.box_weight + state.edge,
    left: 7 * state.box_weight + state.edge,
    color: '#ffc43a',
    text: '12',
    borderWidth: '1px 4px 1px 1px',
  ...
  score[13] = {
    top: 6 * state.box_weight + state.edge,
    left: 7 * state.box_weight + state.edge,
    button: true,
    color: '#3498db',
    text: '13',
  ...
  score[14] = {
    top: 7 * state.box_weight + state.edge,
    left: 7 * state.box_weight + state.edge,
    color: '#ffc43a',
    text: '14',
